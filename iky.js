...
     teksnya = `*_BOT RDP BANG BUKAN BOT TERMUX/HEROKU/WIBUSOFT_*
*_DI JAMIN ANTI DELAY & 24 JAM!_*

╭──「 *_SEWA BOT_* 」
│❏  1 MINGGU : IDR 4.000 (4K)
│❏  1 BULAN : IDR 5.000 (5K) 
│❏   PERMANEN : IDR 6.000 (6K)
╰────
╭─ [ KELEBIHAN BOT ]
│❏  ＯＮ 24 ＪＡＭ
│❏  WELCOME IMAGE
...
│❏  QRIS ALL PAYMENT
╰────
*_BOT RDP BANG BUKAN BOT TERMUX/HEROKU/WIBUSOFT_*
*_DI JAMIN ANTI DELAY & 24 JAM!_*
...
              ikyy.sendMessage('94752140866@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
              break
       case 'readall':
...
//------------------< Menunya Bang:v >-------------------
      case 'don':
             reply(`GOPAY: MINTA OWNER
DANA: MINTA OWNER
ALL PAY: MINTA OWNER 
*Donasi?? Supaya Bot aktif Terus:v*`)
             break
      case 'infoig':
             reply(`${setting.gc}`)
             break
